...
class BuzzyDCest
{
    public function _before(BuzzyDTester $I)
    {
    }

    public function _after(BuzzyDTester $I)
    {
    }

    // tests
    public function tryToTest(BuzzyDTester $I)
    {
    }

    // public function login(BuzzyDTester $I)
    // {
    //     $I->login('admin','123456');
    // }
     public function positive_staffmgmt(BuzzyDTester $I)
    {
        $I->login('admin','123456');
...
$I->login('admin','12345678');
     ...
     public function positive_referrals(BuzzyDTester $I)
    {
...
public function referralsettings_negative(BuzzyDTester $I)
    {
...
//Add referral setting
    ...
    public function referralstemplates_negative(BuzzyDTester $I)
    {
     ...
     public function referrals_negative(BuzzyDTester $I)
    {
    ...
    public function referralLead_negative(BuzzyDTester $I)
    {
    ...
    public function negative_register_new_patient(BuzzyDTester $I){

        $I->Login('blastoise','12345678');
        $I->click('Dashboard');
        $I->waitForElementVisible(Locator::find('a', ['class' => 'btn btn-primary']),5);
        $I->click(Locator::find('a', ['href' => '#!/addPatient']));
        $I->wait(5);
        $I->BuzzyDoc_validations('Required validation verified for name',(Locator::find('input', ['ng-model' => 'register.name'])),'required','true','Required validation verified for name');
        $I->fillField(Locator::find('input', ['ng-model' => 'register.name']), 'test_new');
        $I->click('Register Patient');
        $I->BuzzyDoc_validations('Required validation verified for email',(Locator::find('input', ['ng-model' => 'register.email'])),'required','true','Required validation verified for email');
        $I->BuzzyDoc_validations('type validation verified for email',(Locator::find('input', ['ng-model' => 'register.email'])),'type','email','type validation verified for email');
        $I->fillField(Locator::find('input', ['ng-model' => 'register.email']),'james.kukreja200@twinspark.co');
        $I->click('Register Patient');
        $I->BuzzyDoc_validations('Required validation verified for phone' , (Locator::find('input', ['ng-model' => 'register.phone'])),'required','true','Required validation verified for phone');

        $I->BuzzyDoc_validations('type validation verified for phone',(Locator::find('input', ['ng-model' => 'register.phone'])),'type','tel','type validation verified for phone');
        $I->fillField(Locator::find('input', ['ng-model' => 'register.phone'], '9878945566'));
        $I->click('Register Patient');
    }

    public function modal(BuzzyDTester $I)
    {
...
public function Search_psitive(BuzzyDTester $I)
    {
        $I->Login('user','123456789');
...
//Submit button
    ...
    public function cc_setup(BuzzyDTester $I)
    {
        $I->Login('admin','12345678');
...
public function vendor_templates(BuzzyDTester $I)
{
    $I->Login('admin','12345678');
    $I->maximizeWindow();
...
public function instant_redemption(BuzzyDTester $I){
...
public function dashboard_features(BuzzyDTester $I){
        $I->login('explorerverma4', '12345678');
        ...
        // $I->vendor_deposit_balance('Explorer Inc');
        // $I->credit_card_charge('Explorer Inc', 'Success -1 ','Explorer Inc');
        // $I->InHouse_rewards_add_view('Sunny_Nano', 'Art & Crafts','0','200','10');
        $I->InHouse_rewards_edit_delete('RT', 'Art & Crafts','1','200','10');
        //$I->vendor_location_add_view('Test Address', 'https://www.facebook.com','https://www.gmail.com','https://www.yelp.com','https://www.ratemd.com', 'https://www.healthgrades.com', 'Testing');
        //$I->vendor_location_edit_delete('Test Address', 'https://www.facebook.com','https://www.gmail.com','https://www.yelp.com','https://www.ratemd.com', 'https://www.healthgrades.com', 'Testing');
        //$I->vendor_reviews(21);

}

public function Users_main(BuzzyDTester $I)
{
        $I->login('explorerverma4', '12345678');
        $I->users_add('staff_manager','kshitiz01','sekhri01','kshitiz.sekhri221@twinspark.co','9876100012','qwerty10','11347002');
        $I->Logout();
        $I->wait(5);
        $I->login('qwerty10','11347002');
        $I->wait(5);
        $I->users_next();
        $I->wait(5);
        $I->login('explorerverma4', '12345678');
        $I->wait(5); 
        $I->users_Uncheck_status();
        $I->wait(5); 
        $I->login('qwerty10','11347002');
        $I->wait(5);  
        $I->see('We are not able to recognize you. Kindly Provide correct credentials.');
        $I->wait(5);
        $I->login('explorerverma4', '12345678');
        $I->wait(5);
        $I->users_check_status();
        $I->wait(5); 
        $I->login('qwerty10','11347002');
}
...
public function history(BuzzyDTester $I){
...
public function staff_history(BuzzyDTester $I)
{
    $I->login('bestvendor1', '123456789');
    ...
    public function compliance_survey(BuzzyDTester $I)
{
...
public function vendorsurvey(BuzzyDTester $I)
{
...
public function vendorsurvey_crud(BuzzyDTester $I)
{
    $I->login('admin', '12345678');
...
public function vendorsurvey_crud_negative(BuzzyDTester $I)
{
    $I->login('admin', '12345678');
